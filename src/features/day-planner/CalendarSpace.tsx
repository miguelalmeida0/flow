...
export function CalendarSpace() {
  ...
  return <section className="mx-auto flex min-h-[calc(100dvh-72px)] w-full max-w-[1680px] flex-col pb-36" data-testid="calendar-space">
    <motion.div className="relative flex min-h-[112px] shrink-0 items-end justify-between overflow-hidden border-b border-[#E7E0D9] px-5 pb-6 pt-8 sm:px-9 lg:px-12" layout={reducedMotion ? false : "position"} layoutDependency={calendarLayout} data-world-heading>
